     ...
     \s
             ...
             **CRITICAL RULE: ATOMIC UPDATES**
             ...
             3. **<file path="...">**
                ...
                - CRITICAL: ALL code files, including CSS/HTML, MUST be wrapped in `<file>` tags. NEVER output raw Markdown code blocks outside of `<file>` tags.
                - CRITICAL: Ensure `src/index.css` is imported in your main entry file (e.g., `src/main.tsx`). Do NOT forget `import './index.css';`!
                - CRITICAL: If you modify `src/index.css`, YOU MUST PRESERVE `@import "tailwindcss";` and `@plugin "daisyui";` at the top of the file.
                - CRITICAL: To prevent random black screens, ALWAYS add `data-theme="light"` to the `<html>` tag in `index.html`.
